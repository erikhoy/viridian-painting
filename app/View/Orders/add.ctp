<div class="row">
	<div class="page-heading col col-xs-offset-1 col-xs-10">
		<h1><?php echo $this->Html->link('Orders', array('controller' => 'orders', 'action' => 'index')); ?> > Add Order</h1>
	</div>
</div>
<div class="row">
	<?php echo $this->Form->create('Order'); ?>
	<div class="col col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-4">
	...
	<div class="col col-xs-offset-1 col-xs-10 col-md-offset-2  col-md-9">
	...
	<div class="col col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-3">
	...
	<div class="col col-xs-offset-1 col-xs-10 col-md-2">
		<?php echo $this->Form->input('order_time_start', array('label' => 'Window Start', 'class' => 'timepicker', 'type' => 'text', 'value' => '8:00 AM')); ?>
	</div>
	<div class="col col-xs-offset-1 col-xs-10 col-md-2">
		<?php echo $this->Form->input('order_time_end', array('label' => 'Window End', 'class' => 'timepicker', 'type' => 'text', 'value' => '11:00 AM')); ?>
	</div>
	<div class="clearfix col col-xs-offset-1 col-md-offset-2  col-xs-10 col-md-4">
	...
	<div class="clearfix col col-xs-offset-1 col-xs-10 col-md-offset-2  col-md-4">
	...
	<div class="clearfix col col-xs-offset-1 col-xs-10 col-md-offset-2  col-md-9">
		<?php echo $this->Form->input('notes', array('label' => 'Notes', 'type' => 'textarea')); ?>
	</div>
	<div class="clearfix col col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-5">
		...
		<div class="clearfix col col-xs-12">
			...
			<div class="costs">
				<div class="col col-xs-12 col-md-4">
					<?php echo $this->Form->input('cost', array('label' => 'Cost')); ?>
				</div>
	...
	<div class="clearfix col col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-2">
